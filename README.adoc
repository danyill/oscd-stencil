...
:uri-plugin: https://github.com/danyill/oscd-stencil
:uri-ci-bundle: https://danyill.github.io/oscd-stencil/oscd-stencil.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-stencil/index.deploy.html
...
// badges
image:https://github.com/danyill/oscd-stencil/actions/workflows/test.yml/badge.svg[title='Build Status']
...
This plugin is intended to allow a user to quickly apply a template configuration to other IEDs.
...
. Choose a plugin name of 'Stencil'.
...
. Enter the name 'Stencil', select 'Editor tab' and enter {uri-ci-bundle} as the URL.
+
...
. You should now be able to scroll across in the menu-bar and find a tab, "Stencil"
+
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-stencil/dist/oscd-stencil.js`. 
...
<open-scd
  ...
  "editor": 
  [
    {"name": "Stencil", "translations": {"de": "Späte Bindung des Abonnenten", "pt": "Associação Tardia de Assinante"}, "icon": "link", "active": true, "requireDoc": true, "src": "/plugins/oscd-stencil/dist/oscd-stencil.js"}
  ]
}'
></open-scd>
----
